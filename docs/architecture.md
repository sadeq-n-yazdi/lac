...
```
  ...
  └─────────┬────────┘   └─────────┬──────────┘
            ...
            └──────────┬───────────┘
                       ▼
              ┌────────────────┐
              │ internal/service│   use cases: registry, messaging, leasing, reporting
              └────────┬───────┘
                       ▼
              ┌────────────────┐
...
|-----------------------------|-------------------------------------------------------------------------------------|
| `internal/core`             | Domain types (`Agent`, `Message`, `Resource`, `Lease`, `QueueEntry`, `Report`) and the repository interfaces the services depend on. No I/O, no SQL, no JSON. |
