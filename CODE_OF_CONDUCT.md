...
[@sadeq-n-yazdi](https://github.com/sadeq-n-yazdi), through a direct message on GitHub. All complaints will be reviewed
...
1. **Correction** — A private, written warning from community leaders, providing clarity around the nature of the
...
3. **Temporary Ban** — A temporary ban from any sort of interaction or public communication with the community for a
   specified period of time.
